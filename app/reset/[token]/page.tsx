          ...
          {loading ? (
            ...
            <div className="text-center">
              ...
              <p className="text-[13px] mb-5" style={{ color: "var(--vh-muted)" }}>
                This reset link has expired or already been used. Return to the login page to request a new one.
              </p>
              <a
                href="/login"
            ...
            <>
              ...
              >
                ...
                Resetting password for <strong className="font-medium">{email}</strong>
              </div>
