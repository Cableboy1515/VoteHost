...
export const ACTION_LABELS: Record<ActivityAction, string> = {
  ...
  "election.enter_review":           "Entered write-in review",
  ...
  "settings.email_verify":         "Email connection verified",
  "settings.email_verify_failed":  "Email connection verification failed",
...
export const ACTION_CATEGORIES: Record<ActivityAction, ActionCategory> = {
  ...
  "election.enter_review":           "lifecycle",
  ...
  "settings.email_verify":         "settings",
  "settings.email_verify_failed":  "settings",
